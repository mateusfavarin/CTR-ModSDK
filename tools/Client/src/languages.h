...
private:
	const std::unordered_map<std::string, std::unordered_map<std::string, std::string>> m_translations = {
		...
		TRANSLATE(
			"Installing Saphi settings...",
			"Instalando configurações do Saphi...",
			"Installazione delle impostazioni di Saphi...",
			"Установка настроек для Saphi...",
			"Asennetaan Saphi asetuksia…",
			"...جاري تثبيت اعدادات Saphi",
			"Einstellungen für Saphi werden eingerichtet ...",
			"Memasang pengaturan Saphi...",
			"Instalation des paramètres de Saphi...",
			"Vistar stillingar fyrir Saphi...",
			"Instalando configuraciones de Saphi...",
			"Saphi設定をインストールしています...",
			"Saphi-ის პარამეტრების დაყენება..."
		),
		TRANSLATE(
		...
		TRANSLATE(
			"Error: could not establish connection to projectsaphi.com",
			"Erro: não foi possível estabelecer uma conexão ao projectsaphi.com",
			"Errore: non è stato possibile connettersi a projectsaphi.com",
			"Ошибка: Не удалось соединиться с projectsaphi.com",
			"Virhe: Client ei kykene muodostamaan yhteyttä projectsaphi.com:iin.",
			"خطأ: فشل في الإتصال الى projectsaphi.com",
			"Fehler: Es konnte keine Verbindung zu projectsaphi.com hergestellt werden",
			"Kesalahan: Tidak bisa membuat koneksi ke projectsaphi.com",
			"Erreur: impossible de se connecter à projectsaphi.com",
			"Villa: næst ekki sambandi við projectsaphi.com",
			"Error: no se pudo establecer una conexión con projectsaphi.com",
			"エラー: online-ctr.comとの接続を確立できませんでした.",
			"შეცდომა: ვერ დავუკავშირდით projectsaphi.com"
		),
		TRANSLATE(
			"Update available",
			"Update disponível",
