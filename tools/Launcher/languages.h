...
#define TRANSLATE(EN, PT, IT, RU, FI, AR, DE, ID, FR, IS, ES) {EN,{{"English", EN}, {"Português", PT}, {"Italiano", IT}, {"Pусский", RU}, {"Suomi", FI}, {"عربي", AR}, {"Deutsch", DE}, {"Indonesia", ID}, {"Français", FR}, {"Íslenska", IS}, {"Español", ES}}}
