...
SPINOUT:
	...
	else //if(damageType == 5)
	{
		...
		victimDriver->funcPtrs[0] = DECOMP_VehStuckProc_PlantEaten_Init;
	...
	DECOMP_GAMEPAD_ShockFreq(victimDriver, 8, 0);
	DECOMP_GAMEPAD_ShockForce1(victimDriver, 8, 0x7f);
