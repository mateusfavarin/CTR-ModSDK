...
void DECOMP_RB_ShieldDark_ThTick_Grow(struct Thread *th)
{
  ...
  DECOMP_LHMatrix_Parent(shieldInst, 	driverInst, &pos[0]);
  DECOMP_LHMatrix_Parent(colorInst, 	driverInst, &pos[0]);
  DECOMP_LHMatrix_Parent(highlightInst,driverInst, &pos[0]);
